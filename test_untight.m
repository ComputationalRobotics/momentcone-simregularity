...
%% load data
filepath = "../GNS/data/QS_1.mat";
moment_matrix_info = load(filepath);
moment_matrix_info = moment_matrix_info.data;
n = moment_matrix_info.n;
kappa = moment_matrix_info.kappa;
M = moment_matrix_info.M;

%% construct corresponding constraints
...
[M, ~] = conic_alternating_projection(M, linear_sys, 100, 1e-14);
