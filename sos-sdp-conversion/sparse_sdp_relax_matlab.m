function SDP = sparse_sdp_relax_matlab(problem)
	...
	regularization_sedumi = sparse(1, 1, 1, num_sedumi_variables, 1);
	regularization_sdpt3 = sparse(1, 1, 1, num_sdpt3_variables, 1);
	...
	SDP.sedumi.c = c;
	eq_sedumi = mapt_sedumi * coef_t(:, idx_sdpt3 + 1 : end);
	...
	C = cell(size(K.s));
	eq_sdpt3 = mapt_sdpt3 * coef_t(:, idx_sdpt3 + 1 : end);
